from hype.asyncio.element import (H1, H2, H3, H4, H5, H6, A, Abbr, Address,
                                  Area, Article, Aside, Audio, B, Base, Bdi,
                                  Bdo, Blockquote, Body, Br, Button, Canvas,
                                  Caption, Cite, Code, Col, Colgroup, Data,
                                  Datalist, Dd, Del, Details, Dfn, Dialog, Div,
                                  Dl, Doc, Dt, Element, Em, Embed, Fieldset,
                                  Figcaption, Figure, Footer, Form, Head,
                                  Header, Hgroup, Hr, Html, I, Iframe, Img,
                                  Indent, Input, Ins, Kbd, Label, Legend, Li,
                                  Link, Main, Map, Mark, Math, Menu, Menuitem,
                                  ...
                                  SelfClosingElement, Slot, Small, Source,
